...
#' data(spcolmap)
#'
#' #Perform PCA of shape data for ventral anchors and make 2D plots
#' pcashape <- pca2d(ligophorus_shape[,1:22],labcol=spcolmap$color,phylo=TRUE,phy=ligotree,genus="L. ")
#'
...
#' xyzlabel=c("PC3 (11%)","PC2 (19%)","PC1 (55%)"), mean.show=TRUE)
#'
